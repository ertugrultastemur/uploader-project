    ...
    try {
      http
              ...
              .authorizeHttpRequests(authorize ->authorize.requestMatchers(
                      ...
                      .permitAll()
                      .requestMatchers("http://localhost:8383/v1/doc/getAll").permitAll()
              ...
              .logout(out-> out.logoutUrl("/api/v1/auth/logout").addLogoutHandler(logoutHandler).logoutSuccessHandler((request, response, authentication) -> SecurityContextHolder.clearContext()));
